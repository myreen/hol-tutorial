...
Thus, to indicate the `simp` attribute (for which, see discussion of the stateful simpset in §[Stateful Simpset](#the-stateful-simpset-srw_ss), one can write
```
...
%
over a signature $\Sigma_{\Omega}$ is defined to be an equation, *i.e.*,
